package jfugue.demo.java.org.jfugue.realtime;
...
public class RealtimeDemo {
    public static void main(String[] args) throws MidiUnavailableException {
        ...
        boolean quit = false;
        while (quit == false) {
            System.out.print("Enter a '+C' to start a note, '-C' to stop a note, 'i' for a random instrument, 'p' for a pattern, or 'q' to quit: ");
